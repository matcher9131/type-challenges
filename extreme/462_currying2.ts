...
type DynamicCurry<Result, LeftParams extends unknown[], RightParams> = RightParams extends [infer First, ...infer Rest]
    ? Rest extends []
        ? (...params: [...LeftParams, First]) => Result
        : ((...params: [...LeftParams, First]) => DynamicCurry<Result, [], Rest>) & DynamicCurry<Result, [...LeftParams, First], Rest>
    : () => Result;

declare function DynamicParamsCurrying<P extends unknown[], R>(fn: (...params: P) => R): DynamicCurry<R, [], P>
