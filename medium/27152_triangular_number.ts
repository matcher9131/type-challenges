...
type TriangularInner<N extends number, C extends unknown[] = [], Result extends unknown[] = []> = C["length"] extends N
    ? [...Result, ...C]["length"]
    : TriangularInner<N, [...C, unknown], [...Result, ...C]>

type Triangular<N extends number> = TriangularInner<N>;
