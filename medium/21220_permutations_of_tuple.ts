...
type Insert<T extends unknown[], U> = T extends [infer First, ...infer Rest]
    ? [U, First, ...Rest] | [First, ...Insert<Rest, U>]
    : [U];
type PermutationsOfTupleInner<T extends unknown[], Left extends unknown[]> = T extends [infer First, ...infer Rest]
    ? PermutationsOfTupleInner<Rest, Insert<Left, First>>
    : Left;
type PermutationsOfTuple<T extends unknown[]> = PermutationsOfTupleInner<T, []>
