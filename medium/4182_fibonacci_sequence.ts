...
type FibonacciInner<T extends number, N extends unknown[] = [unknown], C extends unknown[] = [unknown], P extends unknown[] = []> 
    =  N["length"] extends T ? C["length"]
        : FibonacciInner<T, [...N, unknown], [...C, ...P], C>;
type Fibonacci<T extends number> = FibonacciInner<T>;
