...
type DefinedPartialInner<S extends keyof any, Type, T extends keyof any = S> = S extends S
    ? Record<S, Type> | Record<T, Type> | DefinedPartialInner<Exclude<T, S>, Type>
    : never;

type DefinedPartial<T extends Record<string, unknown>> = T extends Record<string, infer U>
    ? DefinedPartialInner<keyof T, U>
    : never;
