...
type MinusOne<N extends number> = [-1, 0, 1, 2, 3, 4][N];
type HanoiInner<N extends number, From extends string = "A", To extends string = "B", Intermediate extends string = "C", Op extends [string, string][] = []>
    = N extends 0
        ? Op
        : [
            // Move disks of stack "From" except the bottom one to stack "Intermediate" 
            ...HanoiInner<MinusOne<N>, From, Intermediate, To>,
            // Move the bottom disk of stack "From" to stack "To"
            [From, To],
            // Move disks of stack "Intermediate" to stack "To"
            ...HanoiInner<MinusOne<N>, Intermediate, To, From>
        ];
type Hanoi<N extends number> = HanoiInner<N>;
