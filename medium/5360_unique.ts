...
type Contains<T extends unknown[], U> = T extends [infer First, ...infer Rest]
    ? Equal<First, U> extends true
        ...
        : Contains<Rest, U>
    : false;
type UniqueInner<T extends unknown[], Result extends unknown[]> = T extends [infer First, ...infer Rest]
    ? Contains<Result, First> extends true
        ? UniqueInner<Rest, Result>
        : UniqueInner<Rest, [...Result, First]>
    : Result;
type Unique<T extends unknown[]> = UniqueInner<T, []>;
