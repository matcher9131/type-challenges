...
type NumberRangeInner<L extends number, H extends number, Result, Tuple extends unknown[]> = Tuple["length"] extends H
    ? Result | H
    : Tuple["length"] extends L
        ? NumberRangeInner<L, H, L, [...Tuple, unknown]>
        : [Result] extends [never]
            ? NumberRangeInner<L, H, Result, [...Tuple, unknown]>
            : NumberRangeInner<L, H, Result | Tuple["length"], [...Tuple, unknown]>
type NumberRange<L extends number, H extends number> = NumberRangeInner<L, H, never, []>;
