...
type IndexOfInner<T extends unknown[], U, C extends unknown[]> = T extends [infer First, ...infer Rest]
    ? Equal<First, U> extends true
        ? C["length"]
        : IndexOfInner<Rest, U, [...C, unknown]>
    : -1;
type IndexOf<T extends unknown[], U> = IndexOfInner<T, U, []>
