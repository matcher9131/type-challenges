...
type PercentageParserInner<A extends string, S, N extends string, P> = A extends `${infer First}${infer Rest}`
    ? First extends "+" | "-"
        ? PercentageParserInner<Rest, First, N, P>
        : First extends "%"
            ? PercentageParserInner<Rest, S, N, "%">
            : PercentageParserInner<Rest, S, `${N}${First}`, P>
    : [S, N, P]

type PercentageParser<A extends string> = PercentageParserInner<A, "", "", "">;
