...
type CheckRepeatedCharsInner<T extends string, U extends string> = T extends `${infer First}${infer Rest}`
    ? First extends U
        ? true
        : CheckRepeatedCharsInner<Rest, U | First>
    : false;
type CheckRepeatedChars<T extends string> = CheckRepeatedCharsInner<T, never>;
