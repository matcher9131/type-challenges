...
type FizzBuzzInner<N extends number, Result extends string[] = [], Mod extends unknown[] = []> = Result["length"] extends N
    ? Result
    : Mod["length"] extends 14
        ? FizzBuzzInner<N, [...Result, "FizzBuzz"], []>
        : Mod["length"] extends 4 | 9
            ? FizzBuzzInner<N, [...Result, "Buzz"], [...Mod, unknown]>
            : Mod["length"] extends 2 | 5 | 8 | 11
                ? FizzBuzzInner<N, [...Result, "Fizz"], [...Mod, unknown]>
                : FizzBuzzInner<N, [...Result, `${[...Result, unknown]["length"]}`], [...Mod, unknown]>;
type FizzBuzz<N extends number> = FizzBuzzInner<N>;
