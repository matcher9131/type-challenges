...
type UnboxInner<T, N extends number, C extends unknown[] = []> = C["length"] extends N
    ? T
    : T extends (...params: any[]) => infer R
        ? UnboxInner<R, N, [...C, unknown]>
        : T extends (infer U)[]
            ? UnboxInner<U, N, [...C, unknown]>
            : T extends Promise<infer P>
                ? UnboxInner<P, N, [...C, unknown]>
                : T;

type Unbox<T, N extends number = -1> = UnboxInner<T, N extends 0 ? -1 : N>;
