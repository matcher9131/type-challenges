...
type Column<G extends Grid, I extends 0 | 1 | 2, J extends 0 | 1 | 2> =
    G[0 | 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8][I][J];
...
type SudokuSolved<G extends Grid> =
    | IsValid<G[0][number][number]>
    | IsValid<G[1][number][number]>
    | IsValid<G[2][number][number]>
    | IsValid<G[3][number][number]>
    | IsValid<G[4][number][number]>
    | IsValid<G[5][number][number]>
    | IsValid<G[6][number][number]>
    | IsValid<G[7][number][number]>
    | IsValid<G[8][number][number]>
    | IsValid<Column<G, 0, 0>>
    | IsValid<Column<G, 0, 1>>
    | IsValid<Column<G, 0, 2>>
    | IsValid<Column<G, 1, 0>>
    | IsValid<Column<G, 1, 1>>
    | IsValid<Column<G, 1, 2>>
    | IsValid<Column<G, 2, 0>>
    | IsValid<Column<G, 2, 1>>
    | IsValid<Column<G, 2, 2>>
    | IsValid<Block<G, 0, 0>>
    | IsValid<Block<G, 0, 1>>
    | IsValid<Block<G, 0, 2>>
    | IsValid<Block<G, 1, 0>>
    ...
    | IsValid<Block<G, 2, 0>>
    | IsValid<Block<G, 2, 1>>
    | IsValid<Block<G, 2, 2>> extends true ? true : false;
